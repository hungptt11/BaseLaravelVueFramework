...
class UsersAndNotesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $user = User::create([
            ...
            'password' => '$2y$10$6k7/EiOl2Ijt.ppEtGZrCe7rVXA8N1QN/Hgl8WecP/8Uv8VPLYbMu', // password 123456
        ...
        for($i = 0; $i<$numberOfUsers; $i++){
            $user = User::create([
                ...
                'email_verified_at' => now(),
                'password' => '$2y$10$6k7/EiOl2Ijt.ppEtGZrCe7rVXA8N1QN/Hgl8WecP/8Uv8VPLYbMu', // password
                'remember_token' => Str::random(10),
                'menuroles' => 'user',
